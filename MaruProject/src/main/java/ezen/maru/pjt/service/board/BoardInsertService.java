...
public class BoardInsertService implements BoardService {
	...
	@Override
	public int noticeWriteProcess(BoardVo boardVo, MultipartRequest uploadFile, HttpServletRequest req) {
...
//					boardVo.setSystem_filename1(system_filename);
	...
	@Override
	public int qnaWriteProcess(BoardVo boardVo, MultipartRequest uploadFile, HttpServletRequest req) {
