  ...
  <section class="container row m-lr-auto m-tb-150">
    ...
    <form action="${MaruContextPath}/order/order_process" method="post" class="col-md-6 m-auto bg2 cl2 p-5">
      ...
      <div class="text-center mt-3">
        <a href="#" id="linkToPay" type="submit" class="btn bg7 cl7 btn-outline-dark">결제하기</a>
        <a href="${MaruContextPath}" id="linkToMain" type="button" class="btn bg7 cl7 btn-outline-dark">계속 쇼핑하기</a>
      </div>
    </form>
  </section>
  <!-- Footer -->
  ...
  <script>
      ...
      function iamport() {
        ...
        IMP.request_pay({
          ...
          name : '테스트용 상품1', //결제창에서 보여질 이름
          amount : order_total_price, //실제 결제되는 가격
