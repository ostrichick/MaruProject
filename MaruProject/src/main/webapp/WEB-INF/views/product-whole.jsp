        ...
        <nav class="limiter-menu-desktop container">
          ...
          <div class="menu-desktop">
            <ul class="main-menu">
              ...
              <li class="active-menu"><a href="product.do">Shop</a></li>

              <li class="label1" data-label1="hot"><a href="shoping-cart.do">Features</a></li>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-lg-3 p-b-50">
          ...
          <div class="p-t-27">
            ...
            </a> <a href="#" class="fs-18 cl7 hov-cl1 trans-04 m-r-16"> <i class="fa fa-instagram"></i>
            </a> <a href="#" class="fs-18 cl7 hov-cl1 trans-04 m-r-16"> <i class="fa fa-pinterest-p"></i>
            </a>
          </div>
        </div>
