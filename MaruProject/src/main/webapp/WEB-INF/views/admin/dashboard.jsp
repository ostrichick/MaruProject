...
<body class="animsition">
  ...
  <section class="container m-t-50">
    ...
    <div class="container w-full txt-center bg6 p-all-30 m-b-50">
      ...
      <table class="table table-bordered table-hover table-stripped" id="mbox">
        <tr class="bg1">
          <th>선택</th>
          <th>상품명</th>
          <th>가격</th>
        ...
        <c:forEach var="product" items="${productList}" varStatus="status">
          <tr class="bg0">
            ...
            <td>
              <a href="${MaruContextPath}/product/delete_process?product_idx=${product.product_idx}" class="btn bg7 cl7 btn-outline-secondary ">삭제</a>
            </td>
          </tr>
        </c:forEach>
