      ...
      <div class="row isotope-grid">
        ...
        <c:forEach var="product" items="${productList}" varStatus="status">
          <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ${product.product_major_category }">
            ...
            <div class="block2">
              <div class="block2-pic hov-img0">
                <a href="detail?product_idx=${product.product_idx}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6"> <img src="${MaruContextPath}/resources/upload/s_${product.origin_filename1}" alt="IMG-PRODUCT">
                </a>
              </div>
              <div class="block2-txt flex-w flex-t p-t-14">
                <div class="block2-txt-child1 flex-col-l ">
