  ...
  <c:when test="${empty indexHeader}">
    <header class="header-v4">
      ...
      <div class="container-menu-desktop">
        ...
        <div class="wrap-menu-desktop how-shadow1">
          <nav class="limiter-menu-desktop container">
            <!-- Logo desktop -->
            <a href="${MaruContextPath}/#" class="logo"> <img src="${MaruContextPath}/resources/images/icons/logo-01.png" alt="logo" /> </a>
      ...
      <div class="menu-mobile">
        ...
        <%-- <a href="${MaruContextPath}/#" class="flex-c-m p-lr-10 trans-04"> 1:1 문의 </a> <a href="${MaruContextPath}/#" class="flex-c-m p-lr-10 trans-04"> My Account </a>
        <a href="${MaruContextPath}/#" class="flex-c-m p-lr-10 trans-04"> EN </a> <a href="${MaruContextPath}/#" class="flex-c-m p-lr-10 trans-04"> USD </a> --%>
        <!--             </div> -->
        <!--           </li> -->
        <!--         </ul> -->
    ...
    <header>
      ...
      <div class="container-menu-desktop">
        ...
        <div class="wrap-menu-desktop">
          <nav class="limiter-menu-desktop container">
            <!-- Logo desktop -->
            <a href="${MaruContextPath}/#" class="logo"> <img src="${MaruContextPath}/resources/images/icons/logo-01.png" alt="IMG-LOGO" /> </a>
      ...
      <ul class="">
        <c:choose>
          <c:when test="${not empty sessionScope.member_id }">
            <li class="m-tb-20 bg7 p-t-10 txt-center cl7">
              ${member_name }님,환영합니다.
        ...
        <li class="m-tb-20 p-t-10 bg7 cl7">
          고객센터
          <ul class="bg6 menu-subcategory">
  ...
  function getCartCount() {
    $.ajax({
      ...
      success: function (result) {
        ...
        console.log(result);
        if (result >= 1) {
          $(".js-show-cart").each(function (index, item) {
            $(item).classList.add("icon-header-noti");
            $(item).attr("data-notify", result);
          });
        } else {
          $(".js-show-cart").each(function (index, item) {
            $(item).classList.remove("icon-header-noti");
            $(item).attr("data-notify", result);
          });
        }
      },
